                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow" role="presentation">
                                ...
                                <a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><#if usuario?has_content>
                    ...
                    <div class="col-lg-4">
                        <div class="card mb-3">
                            <div class="card-body text-center shadow">
                                <#if profile == true>
                                    <#if usuario.perfil?has_content>
                                        <img class="rounded-circle mb-3 mt-4" src="${usuario.perfil}" width="160" height="160">
                                    <#else>
                                    ...
                                    <form class="text-center" action="/upload" method="POST" enctype="multipart/form-data">
                                        <div style="width: 200px;margin: 0 auto;">
                                            <input type="file" id="user_group_logo" class="custom-file-input" accept="image/*" name="user_logo" />
                                    ...
                                    <#else>
                                        <#if user.perfil?has_content>
                                            <img class="rounded-circle mb-3 mt-4" src="${user.perfil}" width="160" height="160">
                                        <#else>
                                            <img class="rounded-circle mb-3 mt-4" src="assets/img/dogs/image2.jpeg" width="160" height="160">
                                        </#if>
                                </#if>
                            ...
                            <div class="card-body">
                                <#if acortados?has_content>
                                    <#list acortados as acortado>
                                        <a href="/r/${acortado.code}" target="_blank"><h4 class="small font-weight-bold">https://pelon1.lospelones.me/r/${acortado.code}</h4></a>
                                    </#list>
                                </#if>
                            </div>
                        </div>
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <#if urls?has_content>
                                    <#list urls as url>
                                        <a href="/r/${url.code}" target="_blank"><h4 class="small font-weight-bold">https://pelon1.lospelones.me/r/${url.code}</h4></a>
                                    </#list>
                                </#if>
                            </div>
                        </div>
